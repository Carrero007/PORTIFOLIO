    ...
    <div class="content">
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            ...
            />
            <div class="buttons">
              <a href="https://github.com/Carrero007/O-Futuro-Chegou" target="_blank" title="Repositório no Github">
                <svg
              ...
              <a href="https://carrero007.github.io/O-Futuro-Chegou/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Site em landing page para um trabalho acadêmico cujo o intuito é mostrar os avanços tecnológicos na área de transportes.
          </p>
      ...
      -->
        <div class="card">
          ...
          <div class="img-wrapper">
            ...
            <div class="buttons">
              ...
              <a href="https://carrero007.github.io/Anna-Velas-e-Sabonetes/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Site com várias páginas para servir como catálogo de produtos.</p>
          <p>HTML - CSS - SCCS - JS</p>
        </div>
        <div class="card">
          <h3>Flor animada em CSS</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/flor.gif" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/Carrero007/flor-rosa" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://carrero007.github.io/flor-rosa/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Páginas feitas para os devs apaixonados💗.</p>
          <p>HTML - CSS - SCCS - JS</p>
        </div>
        <!--<div class="card">
          <h3>Gabriel Medina - Site de principiante</h3>
          <div class="img-wrapper">
        ...
        <div class="card">
          ...
          <p>
            Esse site em que você está, feito para apresentar meus trabalhos, com intuito de mostrar meus conhecimentos.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div></div>
